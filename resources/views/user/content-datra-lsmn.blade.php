...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/tranglichsumuontra(datra).css') }}">
...
<div class="rectangle">  
    <div class="group-2-choosen">
        <div class="div">
            <a class="group-6" href="{{ url('user/content-datra-lsmn') }}">
        ...
        <div class="group-khoi-sach">
            ...
            <div class="khung-chung-sach-lch">
                <div class="khung-anh-sach-lch">
                    <img class="image" src="{{ asset('images/dac-nhan-tam.jpg') }}" />
                </div>
            ...
            <div class="khung-chung-sach-lch">
                <div class="khung-anh-sach-lch">
                    <img class="image" src="{{ asset('images/luoc-su-loai-nguoi.jpg') }}" />
                </div>
                <div class="khung-chu-sach-lch">
