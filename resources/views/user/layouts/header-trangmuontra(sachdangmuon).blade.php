  ...
  <div class="max-header">
    <div class="header-left">
      ...
      <nav class="nav">
        ...
        <a href="{{ route('user.trangmuontra(sachdangmuon)') }}" class="{{ request()->is('user/trangmuontra(sachdangmuon)') ? 'active' : '' }}">Mượn/ Trả sách
          <img src="{{ asset('images/iconstack.io - (Book 2) - purplr bold.png') }}" alt="Mượn/ Trả sách logo" />
        </a>
        <a href="{{ route('user.datchosach') }}">Đặt chỗ
          <img src="{{ asset('images/iconstack.io - (Bookmark).png') }}" alt="Đặt chỗ logo" />
        </a>
        <a href="{{ route('user.tranglichmuontra') }}">Lịch sử
