        ...
        <div class="max-header">
          <div class="header-left">
            ...
            <nav class="nav">
              ...
              <a href="{{ url('user/datchosach') }}" class="active">Đặt chỗ
                <img src="{{ asset('images/iconstack.io - (Bookmark) - purple bold.png') }}" alt="Đặt chỗ logo" />
              </a>
              <a href="{{ url('user/tranglichsumuontra') }}">Lịch sử
                <img src="{{ asset('images/iconstack.io - (History) - normal.png') }}" alt="Lịch sử logo" />
              </a>
            </nav>
          </div>
          ...
          <div class="header-right">
            ...
            <div id="userPopup" class="popup">
                ...
                <div class="popup-item">
                    ...
                    <img src="{{ asset('images/iconstack.io - (Ic Fluent People Search 24 Filled)-popup.png') }}" />
                    </div>
                    <div>
                ...
                <div class="popup-item">
                    <div class="icon-popup">
                    <img src="{{ asset('images/iconstack.io - (Lock Password)-popup.png') }}" />
                    </div>
                    <div>
                ...
                <div class="popup-item">
                    <div class="icon-popup">
                    <img src="{{ asset('images/iconstack.io - (Question Bold)-popup.png') }}" />
                    </div>
                    <div>
                ...
                <div class="popup-item logout">
                    <div class="icon-popup">
                    <img src="{{ asset('images/iconstack.io - (Log Out)-popup.png') }}" />
                    </div>
                    <div>
